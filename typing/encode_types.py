...
titles = []
descriptions = []
with open("/data/chenchao11/pythonprojects/ETZEL-main/data/release/crowd/types_definition.txt", 'rt') as f:
...
max_seq_length = 128
gpu = 0
bert = BertModel.from_pretrained("/data/chenchao11/pythonprojects/ETZEL-main/ETZEL/blink/pretrained")
bert = bert.cuda(gpu)
tokenizer = BertTokenizer.from_pretrained("/data/chenchao11/pythonprojects/ETZEL-main/ETZEL/blink/pretrained", do_lower_case=True)
...
torch.save(types_pooler, "/data/chenchao11/pythonprojects/ETZEL-main/data/release/crowd/types.pt")