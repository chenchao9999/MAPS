...
import os
import time
from train_test_ini import train, test, generate
...
if __name__ == "__main__":
    ...
    if args.mode == "train":
        ...
        for name,para in model.named_parameters():
            if "learned" in name or "final" in name :
        ...
        #     {'params': [p for n, p in model.named_parameters() if 'embeddings' in n or "bert_prompt" in n ], 'weight_decay': 0.01, 'lr': 3e-3}
        # ]
    ...
    if args.mode == "generate":
        ...
        for world in WORLDS:
            ...
            loader = DataLoader(MyDataset(instances), 64, shuffle=False, collate_fn=collate_func)
