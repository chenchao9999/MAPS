...
parser.add_argument('-DATA_DIR', type=str, default='../data/release')
...
parser.add_argument('-random_seed', type=int, default=0, help='0 if randomly initialize the model, other if fix the seed')

parser.add_argument('-bert_dir', type=str, default="/root/autodl-tmp/typing/blink/pretrained/bert-large-uncased")
