...
class BlinkParser(argparse.ArgumentParser):
    ...
    def add_model_args(self, args=None):
        ...
        parser.add_argument("-super_rate", type=float, default=0.05)
        # parser.add_argument('-DATA_DIR', type=str, default='../data/release')
        # parser.add_argument("-batch_size", type=int, default=32)
        # parser.add_argument("-lr", type=float, default=1e-5)
        # parser.add_argument('-bert_dir', type=str, default="/root/autodl-tmp/typing/blink/pretrained/bert-base-uncased")
